			...
			<div class="form-group">
				<div class="col-xs-12">
					<div class="form-material form-material-success">
						...
						@endif
						{{Form::email('ref_email',null,['id'=>'register-email','class'=>'form-control','placeholder'=>'Please provide your email'])}}
						<label for="register-email">Referred By(
							<small>Enter Email Address--Optional</small>
							)</label>
					</div>
				</div>
			</div>
