...
<div class="content bg-white text-center pulldown overflow-hidden">
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3">
			<!-- Error Titles -->
			<h1 class="font-s128 font-w300 text-modern animated zoomInDown">@section('error_name')@show</h1>
			<h2 class="h3 font-w300 push-50 animated fadeInUp">@section('error_message')@show</h2>
			<!-- END Error Titles -->
...
<div class="content pulldown text-muted text-center">
	...
	<a class="link-effect" href="javascript:void(0)">Report it</a> or <a class="link-effect"
	                                                                     href="base_pages_dashboard.html">Go Back to
		Dashboard</a>
</div>
<!-- END Error Footer -->
