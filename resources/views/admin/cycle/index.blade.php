		...
		<div class="col-lg-12">
			...
			<div class="block block-themed">
				<div class="block-header bg-primary">
					...
					<h3 class="block-title">Add New Cycler</h3>
				</div>
				<div class="block-content">
					{!! Form::open(array('url' => 'admin/cycler','class'=>'form-horizontal push-10-t push-10')) !!}
					<div class="form-group">
						<div class="col-xs-3">
							<div class="form-material floating">
								<input class="form-control" type="text" id="login3-username" name="amount">
						...
						<div class="col-xs-3">
							<div class="form-material floating">
								<input class="form-control" type="text" id="login3-username" name="percentage">
