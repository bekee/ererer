		...
		<div class="col-lg-6">
			...
			<div class="block block-themed">
				...
				<div class="block-content">
					{!! Form::model($bank,array('url' => ['admin/banks',$bank->id],'method'=>'PATCH','class'=>'form-horizontal push-10-t push-10')) !!}
						<div class="form-group">
							<div class="col-xs-12">
								<div class="form-material floating">
									{{Form::text('bank',$bank->name,['id'=>'login3-username','class'=>'form-control'])}}
									@if ($errors->has('bank'))
